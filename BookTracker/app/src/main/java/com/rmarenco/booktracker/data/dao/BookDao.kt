package com.rmarenco.booktracker.data.dao
...
import com.rmarenco.booktracker.data.models.BookAndPublisher
...
interface BookDao {
    ...
    fun getPublisherWithBook(): LiveData<List<BookAndPublisher>>
}